    ...
    api.cast_channel = (function () {
      ...
      cast_channel.CastMessage = (function () {
        ...
        CastMessage.decode = function decode(reader, length) {
          ...
          var end = length === undefined ? reader.len : reader.pos + length,
            message = new $root.extensions.api.cast_channel.CastMessage();
        ...
        CastMessage.verify = function verify(message) {
          ...
          if (message.payloadUtf8 != null && message.hasOwnProperty('payloadUtf8'))
            if (!$util.isString(message.payloadUtf8)) return 'payloadUtf8: string expected';
          if (message.payloadBinary != null && message.hasOwnProperty('payloadBinary'))
            if (
              !(
                (message.payloadBinary && typeof message.payloadBinary.length === 'number') ||
                $util.isString(message.payloadBinary)
              )
            )
        ...
        CastMessage.fromObject = function fromObject(object) {
          if (object instanceof $root.extensions.api.cast_channel.CastMessage) return object;
          ...
          if (object.payloadUtf8 != null) message.payloadUtf8 = String(object.payloadUtf8);
          if (object.payloadBinary != null)
            if (typeof object.payloadBinary === 'string')
              $util.base64.decode(
                object.payloadBinary,
                (message.payloadBinary = $util.newBuffer($util.base64.length(object.payloadBinary))),
                0,
              );
            else if (object.payloadBinary.length >= 0) message.payloadBinary = object.payloadBinary;
          return message;
        };
        ...
        CastMessage.toObject = function toObject(message, options) {
          ...
          if (options.defaults) {
            ...
            object.payloadUtf8 = '';
            if (options.bytes === String) object.payloadBinary = '';
            else {
              object.payloadBinary = [];
              if (options.bytes !== Array) object.payloadBinary = $util.newBuffer(object.payloadBinary);
            }
          }
          if (message.protocolVersion != null && message.hasOwnProperty('protocolVersion'))
            object.protocolVersion =
              options.enums === String
                ? $root.extensions.api.cast_channel.CastMessage.ProtocolVersion[message.protocolVersion] === undefined
                  ? message.protocolVersion
                  : $root.extensions.api.cast_channel.CastMessage.ProtocolVersion[message.protocolVersion]
                : message.protocolVersion;
          if (message.sourceId != null && message.hasOwnProperty('sourceId')) object.sourceId = message.sourceId;
          ...
          if (message.payloadType != null && message.hasOwnProperty('payloadType'))
            object.payloadType =
              options.enums === String
                ? $root.extensions.api.cast_channel.CastMessage.PayloadType[message.payloadType] === undefined
                  ? message.payloadType
                  : $root.extensions.api.cast_channel.CastMessage.PayloadType[message.payloadType]
                : message.payloadType;
          if (message.payloadUtf8 != null && message.hasOwnProperty('payloadUtf8'))
          ...
          if (message.payloadBinary != null && message.hasOwnProperty('payloadBinary'))
            object.payloadBinary =
              options.bytes === String
                ? $util.base64.encode(message.payloadBinary, 0, message.payloadBinary.length)
                : options.bytes === Array
                  ? Array.prototype.slice.call(message.payloadBinary)
      ...
      cast_channel.AuthChallenge = (function () {
        ...
        AuthChallenge.decode = function decode(reader, length) {
          if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
          var end = length === undefined ? reader.len : reader.pos + length,
            message = new $root.extensions.api.cast_channel.AuthChallenge();
          while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
              default:
        ...
        AuthChallenge.fromObject = function fromObject(object) {
          if (object instanceof $root.extensions.api.cast_channel.AuthChallenge) return object;
      ...
      cast_channel.AuthResponse = (function () {
        ...
        AuthResponse.decode = function decode(reader, length) {
          if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
          var end = length === undefined ? reader.len : reader.pos + length,
            message = new $root.extensions.api.cast_channel.AuthResponse();
          while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
              case 1: {
              ...
              case 3: {
                if (!(message.clientCa && message.clientCa.length)) message.clientCa = [];
        ...
        AuthResponse.verify = function verify(message) {
          if (typeof message !== 'object' || message === null) return 'object expected';
          if (
            !((message.signature && typeof message.signature.length === 'number') || $util.isString(message.signature))
          )
            return 'signature: buffer expected';
          if (
            !(
              (message.clientAuthCertificate && typeof message.clientAuthCertificate.length === 'number') ||
              $util.isString(message.clientAuthCertificate)
            )
          )
            return 'clientAuthCertificate: buffer expected';
          if (message.clientCa != null && message.hasOwnProperty('clientCa')) {
            if (!Array.isArray(message.clientCa)) return 'clientCa: array expected';
            for (var i = 0; i < message.clientCa.length; ++i)
              if (
                !(
                  (message.clientCa[i] && typeof message.clientCa[i].length === 'number') ||
                  $util.isString(message.clientCa[i])
                )
              )
        ...
        AuthResponse.fromObject = function fromObject(object) {
          if (object instanceof $root.extensions.api.cast_channel.AuthResponse) return object;
          ...
          if (object.clientAuthCertificate != null)
            if (typeof object.clientAuthCertificate === 'string')
              $util.base64.decode(
                ...
                (message.clientAuthCertificate = $util.newBuffer($util.base64.length(object.clientAuthCertificate))),
                0,
              );
          ...
          if (object.clientCa) {
            ...
            for (var i = 0; i < object.clientCa.length; ++i)
              if (typeof object.clientCa[i] === 'string')
                $util.base64.decode(
                  object.clientCa[i],
                  (message.clientCa[i] = $util.newBuffer($util.base64.length(object.clientCa[i]))),
                  0,
                );
              else if (object.clientCa[i].length >= 0) message.clientCa[i] = object.clientCa[i];
          }
          return message;
        };
        ...
        AuthResponse.toObject = function toObject(message, options) {
          if (!options) options = {};
          var object = {};
          if (options.arrays || options.defaults) object.clientCa = [];
          if (options.defaults) {
            ...
            if (options.bytes === String) object.clientAuthCertificate = '';
            else {
              object.clientAuthCertificate = [];
              if (options.bytes !== Array) object.clientAuthCertificate = $util.newBuffer(object.clientAuthCertificate);
            }
          }
          ...
          if (message.clientAuthCertificate != null && message.hasOwnProperty('clientAuthCertificate'))
            object.clientAuthCertificate =
              options.bytes === String
                ? $util.base64.encode(message.clientAuthCertificate, 0, message.clientAuthCertificate.length)
                : options.bytes === Array
                  ? Array.prototype.slice.call(message.clientAuthCertificate)
                  : message.clientAuthCertificate;
          if (message.clientCa && message.clientCa.length) {
            object.clientCa = [];
            for (var j = 0; j < message.clientCa.length; ++j)
              object.clientCa[j] =
                options.bytes === String
                  ? $util.base64.encode(message.clientCa[j], 0, message.clientCa[j].length)
                  : options.bytes === Array
                    ? Array.prototype.slice.call(message.clientCa[j])
                    : message.clientCa[j];
          }
          return object;
        };
      ...
      cast_channel.AuthError = (function () {
        ...
        AuthError.decode = function decode(reader, length) {
          if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
          var end = length === undefined ? reader.len : reader.pos + length,
            message = new $root.extensions.api.cast_channel.AuthError();
          while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
              case 1: {
        ...
        AuthError.fromObject = function fromObject(object) {
          if (object instanceof $root.extensions.api.cast_channel.AuthError) return object;
        ...
        AuthError.toObject = function toObject(message, options) {
          if (!options) options = {};
          var object = {};
          if (options.defaults) object.errorType = options.enums === String ? 'INTERNAL_ERROR' : 0;
          if (message.errorType != null && message.hasOwnProperty('errorType'))
            object.errorType =
              options.enums === String
                ? $root.extensions.api.cast_channel.AuthError.ErrorType[message.errorType] === undefined
                  ? message.errorType
                  : $root.extensions.api.cast_channel.AuthError.ErrorType[message.errorType]
                : message.errorType;
          return object;
        };
      ...
      cast_channel.DeviceAuthMessage = (function () {
        ...
        DeviceAuthMessage.encode = function encode(message, writer) {
          ...
          if (message.challenge != null && Object.hasOwnProperty.call(message, 'challenge'))
            $root.extensions.api.cast_channel.AuthChallenge.encode(
              message.challenge,
              writer.uint32(/* id 1, wireType 2 =*/ 10).fork(),
            ).ldelim();
          if (message.response != null && Object.hasOwnProperty.call(message, 'response'))
            $root.extensions.api.cast_channel.AuthResponse.encode(
              message.response,
              writer.uint32(/* id 2, wireType 2 =*/ 18).fork(),
            ).ldelim();
          if (message.error != null && Object.hasOwnProperty.call(message, 'error'))
            $root.extensions.api.cast_channel.AuthError.encode(
              message.error,
        ...
        DeviceAuthMessage.decode = function decode(reader, length) {
          if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
          var end = length === undefined ? reader.len : reader.pos + length,
            message = new $root.extensions.api.cast_channel.DeviceAuthMessage();
          while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
              case 1: {
        ...
        DeviceAuthMessage.fromObject = function fromObject(object) {
          if (object instanceof $root.extensions.api.cast_channel.DeviceAuthMessage) return object;
